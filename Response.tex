...
\begin{itemize}
    \item 
        ...
        \begin{correction}
            ...
            \begin{figure}
                \subcaptionbox{Position space view of reachability sets}{\includegraphics[width=0.5\textwidth]{trajectory_varying_um.pdf}}~
                \subcaptionbox{\Poincare section view of reachability sets}{\includegraphics[width=0.5\textwidth]{poincare_section_varying_um.pdf}}
...
\subcaptionbox{\Poincare section: Minimum distance states from each iteration of the reachability set analysis (red) with respect to the stable invariant manifold (green)\label{fig:geo_transfer_poincare}}{\includegraphics[width=0.4\textwidth]{poincare}}
    ...
    The control always remains within the maximum bound.\label{fig:control_input_geo}}{\includegraphics[width=0.4\textwidth]{control_input_geo.pdf}}
...
The final reachability set intersects the stable manifold and enables a large final manuever to the target orbit.\label{fig:jacobi_geo}}{\includegraphics[width=0.4\textwidth]{jacobi_energy.pdf}}
